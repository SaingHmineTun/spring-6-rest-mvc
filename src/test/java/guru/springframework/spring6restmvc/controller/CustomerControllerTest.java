...
class CustomerControllerTest {
    ...
    @Test
    void test_getCustomerById_throwNotFoundException() throws Exception {

        given(customerService.getCustomerById(any(UUID.class))).willThrow(BeerNotFoundException.class);
